---
description: >-
  Classification Tool - Production-Ready Tool Specification.
...
# 🛠️ Classification Tool

> **Capability**: Allows the agent to perform **classification_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes classification_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `classification_tool:execute`).
...
def execute_classification_tool(input_data: ClassificationToolInput) -> str:
    """
    Implements the core logic for Classification Tool.
    """
