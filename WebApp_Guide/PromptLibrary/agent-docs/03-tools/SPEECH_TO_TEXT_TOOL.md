---
description: >-
  Speech To Text Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **speech_to_text_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes speech_to_text_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `speech_to_text_tool:execute`).
...
def execute_speech_to_text_tool(input_data: SpeechToTextToolInput) -> str:
    """
    Implements the core logic for Speech To Text Tool.
    """
