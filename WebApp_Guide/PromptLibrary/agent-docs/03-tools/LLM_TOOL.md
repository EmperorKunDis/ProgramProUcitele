---
description: >-
  Llm Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **llm_tool** operations securely and efficiently.
...
{
  "name": "llm_tool",
  "description": "Executes llm_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `llm_tool:execute`).
...
def execute_llm_tool(input_data: LlmToolInput) -> str:
    """
    Implements the core logic for Llm Tool.
    """
