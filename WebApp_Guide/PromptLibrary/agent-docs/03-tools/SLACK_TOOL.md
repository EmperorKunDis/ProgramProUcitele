---
description: >-
  Slack Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **slack_tool** operations securely and efficiently.
...
{
  "name": "slack_tool",
  "description": "Executes slack_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `slack_tool:execute`).
...
def execute_slack_tool(input_data: SlackToolInput) -> str:
    """
    Implements the core logic for Slack Tool.
    """
