---
description: >-
  Airtable Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **airtable_tool** operations securely and efficiently.
...
{
  "name": "airtable_tool",
  "description": "Executes airtable_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `airtable_tool:execute`).
...
def execute_airtable_tool(input_data: AirtableToolInput) -> str:
    """
    Implements the core logic for Airtable Tool.
    """
