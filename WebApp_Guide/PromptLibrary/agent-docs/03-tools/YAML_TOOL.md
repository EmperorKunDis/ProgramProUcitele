---
description: >-
  Yaml Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **yaml_tool** operations securely and efficiently.
...
{
  "name": "yaml_tool",
  "description": "Executes yaml_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `yaml_tool:execute`).
...
class YamlToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_yaml_tool(input_data: YamlToolInput) -> str:
    """
    Implements the core logic for Yaml Tool.
    """
