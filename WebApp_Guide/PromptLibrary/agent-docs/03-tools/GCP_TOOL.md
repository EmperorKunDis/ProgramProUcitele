---
description: >-
  Gcp Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **gcp_tool** operations securely and efficiently.
...
{
  "name": "gcp_tool",
  "description": "Executes gcp_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `gcp_tool:execute`).
...
class GcpToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_gcp_tool(input_data: GcpToolInput) -> str:
    """
    Implements the core logic for Gcp Tool.
    """
