---
description: >-
  Python Repl Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **python_repl_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes python_repl_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `python_repl_tool:execute`).
...
def execute_python_repl_tool(input_data: PythonReplToolInput) -> str:
    """
    Implements the core logic for Python Repl Tool.
    """
