---
description: >-
  Package Manager Tool - Production-Ready Tool Specification.
...
# 🛠️ Package Manager Tool

> **Capability**: Allows the agent to perform **package_manager_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes package_manager_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `package_manager_tool:execute`).
...
def execute_package_manager_tool(input_data: PackageManagerToolInput) -> str:
    """
    Implements the core logic for Package Manager Tool.
    """
