---
description: >-
  Pdf Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **pdf_tool** operations securely and efficiently.
...
{
  "name": "pdf_tool",
  "description": "Executes pdf_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `pdf_tool:execute`).
...
def execute_pdf_tool(input_data: PdfToolInput) -> str:
    """
    Implements the core logic for Pdf Tool.
    """
