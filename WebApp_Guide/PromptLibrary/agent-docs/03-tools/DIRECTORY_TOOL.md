---
description: >-
  Directory Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **directory_tool** operations securely and efficiently.
...
{
  "name": "directory_tool",
  "description": "Executes directory_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `directory_tool:execute`).
...
def execute_directory_tool(input_data: DirectoryToolInput) -> str:
    """
    Implements the core logic for Directory Tool.
    """
