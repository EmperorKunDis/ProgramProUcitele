---
description: >-
  Image Generation Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **image_generation_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes image_generation_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `image_generation_tool:execute`).
...
def execute_image_generation_tool(input_data: ImageGenerationToolInput) -> str:
    """
    Implements the core logic for Image Generation Tool.
    """
