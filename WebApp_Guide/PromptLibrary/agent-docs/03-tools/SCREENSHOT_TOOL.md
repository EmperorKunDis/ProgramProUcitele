---
description: >-
  Screenshot Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **screenshot_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes screenshot_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `screenshot_tool:execute`).
...
def execute_screenshot_tool(input_data: ScreenshotToolInput) -> str:
    """
    Implements the core logic for Screenshot Tool.
    """
