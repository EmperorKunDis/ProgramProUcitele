---
description: >-
  Calendar Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **calendar_tool** operations securely and efficiently.
...
{
  "name": "calendar_tool",
  "description": "Executes calendar_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `calendar_tool:execute`).
...
def execute_calendar_tool(input_data: CalendarToolInput) -> str:
    """
    Implements the core logic for Calendar Tool.
    """
