---
description: >-
  Tool Selection - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **tool_selection** operations securely and efficiently.
...
{
  "name": "tool_selection",
  "description": "Executes tool_selection operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `tool_selection:execute`).
...
def execute_tool_selection(input_data: ToolSelectionInput) -> str:
    """
    Implements the core logic for Tool Selection.
    """
