---
description: >-
  Translation Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **translation_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes translation_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `translation_tool:execute`).
...
def execute_translation_tool(input_data: TranslationToolInput) -> str:
    """
    Implements the core logic for Translation Tool.
    """
