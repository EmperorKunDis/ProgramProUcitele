---
description: >-
  Lambda Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **lambda_tool** operations securely and efficiently.
...
{
  "name": "lambda_tool",
  "description": "Executes lambda_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `lambda_tool:execute`).
...
def execute_lambda_tool(input_data: LambdaToolInput) -> str:
    """
    Implements the core logic for Lambda Tool.
    """
