---
description: >-
  Email Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **email_tool** operations securely and efficiently.
...
{
  "name": "email_tool",
  "description": "Executes email_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `email_tool:execute`).
...
def execute_email_tool(input_data: EmailToolInput) -> str:
    """
    Implements the core logic for Email Tool.
    """
