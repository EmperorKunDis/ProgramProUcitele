---
description: >-
  Notification Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **notification_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes notification_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `notification_tool:execute`).
...
def execute_notification_tool(input_data: NotificationToolInput) -> str:
    """
    Implements the core logic for Notification Tool.
    """
