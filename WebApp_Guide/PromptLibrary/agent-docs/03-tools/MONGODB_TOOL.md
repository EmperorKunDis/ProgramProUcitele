---
description: >-
  Mongodb Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **mongodb_tool** operations securely and efficiently.
...
{
  "name": "mongodb_tool",
  "description": "Executes mongodb_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `mongodb_tool:execute`).
...
def execute_mongodb_tool(input_data: MongodbToolInput) -> str:
    """
    Implements the core logic for Mongodb Tool.
    """
