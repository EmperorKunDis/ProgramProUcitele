---
description: >-
  Erp Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **erp_tool** operations securely and efficiently.
...
{
  "name": "erp_tool",
  "description": "Executes erp_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `erp_tool:execute`).
...
def execute_erp_tool(input_data: ErpToolInput) -> str:
    """
    Implements the core logic for Erp Tool.
    """
