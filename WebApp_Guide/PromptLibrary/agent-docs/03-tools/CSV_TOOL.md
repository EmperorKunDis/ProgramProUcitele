---
description: >-
  Csv Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **csv_tool** operations securely and efficiently.
...
{
  "name": "csv_tool",
  "description": "Executes csv_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `csv_tool:execute`).
...
def execute_csv_tool(input_data: CsvToolInput) -> str:
    """
    Implements the core logic for Csv Tool.
    """
