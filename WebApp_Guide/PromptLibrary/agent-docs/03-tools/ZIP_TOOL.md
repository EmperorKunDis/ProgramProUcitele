---
description: >-
  Zip Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **zip_tool** operations securely and efficiently.
...
{
  "name": "zip_tool",
  "description": "Executes zip_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `zip_tool:execute`).
...
def execute_zip_tool(input_data: ZipToolInput) -> str:
    """
    Implements the core logic for Zip Tool.
    """
