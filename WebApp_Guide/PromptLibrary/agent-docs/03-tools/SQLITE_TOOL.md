---
description: >-
  Sqlite Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **sqlite_tool** operations securely and efficiently.
...
{
  "name": "sqlite_tool",
  "description": "Executes sqlite_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `sqlite_tool:execute`).
...
def execute_sqlite_tool(input_data: SqliteToolInput) -> str:
    """
    Implements the core logic for Sqlite Tool.
    """
