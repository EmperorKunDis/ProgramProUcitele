---
description: >-
  Graphql Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **graphql_tool** operations securely and efficiently.
...
{
  "name": "graphql_tool",
  "description": "Executes graphql_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `graphql_tool:execute`).
...
def execute_graphql_tool(input_data: GraphqlToolInput) -> str:
    """
    Implements the core logic for Graphql Tool.
    """
