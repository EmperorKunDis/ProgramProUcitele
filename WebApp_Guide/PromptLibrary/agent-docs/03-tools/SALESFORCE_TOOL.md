---
description: >-
  Salesforce Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **salesforce_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes salesforce_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `salesforce_tool:execute`).
...
def execute_salesforce_tool(input_data: SalesforceToolInput) -> str:
    """
    Implements the core logic for Salesforce Tool.
    """
