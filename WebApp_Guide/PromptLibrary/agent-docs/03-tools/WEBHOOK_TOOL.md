---
description: >-
  Webhook Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **webhook_tool** operations securely and efficiently.
...
{
  "name": "webhook_tool",
  "description": "Executes webhook_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `webhook_tool:execute`).
...
def execute_webhook_tool(input_data: WebhookToolInput) -> str:
    """
    Implements the core logic for Webhook Tool.
    """
