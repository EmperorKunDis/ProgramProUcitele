---
description: >-
  Sms Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **sms_tool** operations securely and efficiently.
...
{
  "name": "sms_tool",
  "description": "Executes sms_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `sms_tool:execute`).
...
def execute_sms_tool(input_data: SmsToolInput) -> str:
    """
    Implements the core logic for Sms Tool.
    """
