---
description: >-
  Kubernetes Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **kubernetes_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes kubernetes_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `kubernetes_tool:execute`).
...
def execute_kubernetes_tool(input_data: KubernetesToolInput) -> str:
    """
    Implements the core logic for Kubernetes Tool.
    """
