---
description: >-
  Markdown Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **markdown_tool** operations securely and efficiently.
...
{
  "name": "markdown_tool",
  "description": "Executes markdown_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `markdown_tool:execute`).
...
def execute_markdown_tool(input_data: MarkdownToolInput) -> str:
    """
    Implements the core logic for Markdown Tool.
    """
