---
description: >-
  Terraform Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **terraform_tool** operations securely and efficiently.
...
{
  "name": "terraform_tool",
  "description": "Executes terraform_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `terraform_tool:execute`).
...
def execute_terraform_tool(input_data: TerraformToolInput) -> str:
    """
    Implements the core logic for Terraform Tool.
    """
