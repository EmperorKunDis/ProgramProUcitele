---
description: >-
  Git Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **git_tool** operations securely and efficiently.
...
{
  "name": "git_tool",
  "description": "Executes git_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `git_tool:execute`).
...
def execute_git_tool(input_data: GitToolInput) -> str:
    """
    Implements the core logic for Git Tool.
    """
