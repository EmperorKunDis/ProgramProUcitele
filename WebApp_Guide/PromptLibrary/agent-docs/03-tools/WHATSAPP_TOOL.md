---
description: >-
  Whatsapp Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **whatsapp_tool** operations securely and efficiently.
...
{
  "name": "whatsapp_tool",
  "description": "Executes whatsapp_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `whatsapp_tool:execute`).
...
def execute_whatsapp_tool(input_data: WhatsappToolInput) -> str:
    """
    Implements the core logic for Whatsapp Tool.
    """
