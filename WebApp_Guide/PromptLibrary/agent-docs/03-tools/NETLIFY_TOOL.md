---
description: >-
  Netlify Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **netlify_tool** operations securely and efficiently.
...
{
  "name": "netlify_tool",
  "description": "Executes netlify_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `netlify_tool:execute`).
...
class NetlifyToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_netlify_tool(input_data: NetlifyToolInput) -> str:
    """
    Implements the core logic for Netlify Tool.
    """
