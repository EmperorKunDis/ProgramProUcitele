---
description: >-
  Notion Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **notion_tool** operations securely and efficiently.
...
{
  "name": "notion_tool",
  "description": "Executes notion_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `notion_tool:execute`).
...
def execute_notion_tool(input_data: NotionToolInput) -> str:
    """
    Implements the core logic for Notion Tool.
    """
