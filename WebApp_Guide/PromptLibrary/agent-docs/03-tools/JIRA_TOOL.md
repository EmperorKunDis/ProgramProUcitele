---
description: >-
  Jira Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **jira_tool** operations securely and efficiently.
...
{
  "name": "jira_tool",
  "description": "Executes jira_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `jira_tool:execute`).
...
def execute_jira_tool(input_data: JiraToolInput) -> str:
    """
    Implements the core logic for Jira Tool.
    """
