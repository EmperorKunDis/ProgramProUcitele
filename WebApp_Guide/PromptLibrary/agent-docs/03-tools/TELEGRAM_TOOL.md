---
description: >-
  Telegram Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **telegram_tool** operations securely and efficiently.
...
{
  "name": "telegram_tool",
  "description": "Executes telegram_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `telegram_tool:execute`).
...
def execute_telegram_tool(input_data: TelegramToolInput) -> str:
    """
    Implements the core logic for Telegram Tool.
    """
