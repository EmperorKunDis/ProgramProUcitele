---
description: >-
  File Manager Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **file_manager_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes file_manager_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `file_manager_tool:execute`).
...
def execute_file_manager_tool(input_data: FileManagerToolInput) -> str:
    """
    Implements the core logic for File Manager Tool.
    """
