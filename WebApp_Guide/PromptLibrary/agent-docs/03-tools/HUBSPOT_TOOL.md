---
description: >-
  Hubspot Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **hubspot_tool** operations securely and efficiently.
...
{
  "name": "hubspot_tool",
  "description": "Executes hubspot_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `hubspot_tool:execute`).
...
def execute_hubspot_tool(input_data: HubspotToolInput) -> str:
    """
    Implements the core logic for Hubspot Tool.
    """
