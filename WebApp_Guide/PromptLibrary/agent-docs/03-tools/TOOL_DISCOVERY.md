---
description: >-
  Tool Discovery - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **tool_discovery** operations securely and efficiently.
...
{
  "name": "tool_discovery",
  "description": "Executes tool_discovery operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `tool_discovery:execute`).
...
def execute_tool_discovery(input_data: ToolDiscoveryInput) -> str:
    """
    Implements the core logic for Tool Discovery.
    """
