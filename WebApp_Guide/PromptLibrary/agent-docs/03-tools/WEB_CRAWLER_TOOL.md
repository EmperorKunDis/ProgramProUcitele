---
description: >-
  Web Crawler Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **web_crawler_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes web_crawler_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `web_crawler_tool:execute`).
...
def execute_web_crawler_tool(input_data: WebCrawlerToolInput) -> str:
    """
    Implements the core logic for Web Crawler Tool.
    """
