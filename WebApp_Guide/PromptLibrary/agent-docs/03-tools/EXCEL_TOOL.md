---
description: >-
  Excel Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **excel_tool** operations securely and efficiently.
...
{
  "name": "excel_tool",
  "description": "Executes excel_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `excel_tool:execute`).
...
def execute_excel_tool(input_data: ExcelToolInput) -> str:
    """
    Implements the core logic for Excel Tool.
    """
