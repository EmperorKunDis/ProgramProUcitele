---
description: >-
  Json Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **json_tool** operations securely and efficiently.
...
{
  "name": "json_tool",
  "description": "Executes json_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `json_tool:execute`).
...
def execute_json_tool(input_data: JsonToolInput) -> str:
    """
    Implements the core logic for Json Tool.
    """
