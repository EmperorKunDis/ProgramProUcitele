---
description: >-
  Vision Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **vision_tool** operations securely and efficiently.
...
{
  "name": "vision_tool",
  "description": "Executes vision_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `vision_tool:execute`).
...
def execute_vision_tool(input_data: VisionToolInput) -> str:
    """
    Implements the core logic for Vision Tool.
    """
