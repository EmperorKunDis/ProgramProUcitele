---
description: >-
  Crm Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **crm_tool** operations securely and efficiently.
...
{
  "name": "crm_tool",
  "description": "Executes crm_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `crm_tool:execute`).
...
def execute_crm_tool(input_data: CrmToolInput) -> str:
    """
    Implements the core logic for Crm Tool.
    """
