---
description: >-
  Redis Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **redis_tool** operations securely and efficiently.
...
{
  "name": "redis_tool",
  "description": "Executes redis_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `redis_tool:execute`).
...
class RedisToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_redis_tool(input_data: RedisToolInput) -> str:
    """
    Implements the core logic for Redis Tool.
    """
