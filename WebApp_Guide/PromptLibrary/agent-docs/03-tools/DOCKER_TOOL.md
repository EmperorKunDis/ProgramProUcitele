---
description: >-
  Docker Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **docker_tool** operations securely and efficiently.
...
{
  "name": "docker_tool",
  "description": "Executes docker_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `docker_tool:execute`).
...
def execute_docker_tool(input_data: DockerToolInput) -> str:
    """
    Implements the core logic for Docker Tool.
    """
