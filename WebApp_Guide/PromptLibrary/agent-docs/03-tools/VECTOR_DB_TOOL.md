---
description: >-
  Vector Db Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **vector_db_tool** operations securely and efficiently.
...
{
  "name": "vector_db_tool",
  "description": "Executes vector_db_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `vector_db_tool:execute`).
...
def execute_vector_db_tool(input_data: VectorDbToolInput) -> str:
    """
    Implements the core logic for Vector Db Tool.
    """
