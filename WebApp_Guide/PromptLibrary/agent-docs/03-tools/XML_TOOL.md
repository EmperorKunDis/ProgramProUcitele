---
description: >-
  Xml Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **xml_tool** operations securely and efficiently.
...
{
  "name": "xml_tool",
  "description": "Executes xml_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `xml_tool:execute`).
...
class XmlToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_xml_tool(input_data: XmlToolInput) -> str:
    """
    Implements the core logic for Xml Tool.
    """
