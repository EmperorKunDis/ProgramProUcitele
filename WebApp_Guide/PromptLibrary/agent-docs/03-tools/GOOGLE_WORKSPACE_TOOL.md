---
description: >-
  Google Workspace Tool - Production-Ready Tool Specification.
...
# 🛠️ Google Workspace Tool

> **Capability**: Allows the agent to perform **google_workspace_tool** operations securely and efficiently.
...
```json
{
  ...
  "description": "Executes google_workspace_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `google_workspace_tool:execute`).
...
def execute_google_workspace_tool(input_data: GoogleWorkspaceToolInput) -> str:
    """
    Implements the core logic for Google Workspace Tool.
    """
