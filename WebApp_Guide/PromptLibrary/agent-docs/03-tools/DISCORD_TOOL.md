---
description: >-
  Discord Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **discord_tool** operations securely and efficiently.
...
{
  "name": "discord_tool",
  "description": "Executes discord_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `discord_tool:execute`).
...
class DiscordToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_discord_tool(input_data: DiscordToolInput) -> str:
    """
    Implements the core logic for Discord Tool.
    """
