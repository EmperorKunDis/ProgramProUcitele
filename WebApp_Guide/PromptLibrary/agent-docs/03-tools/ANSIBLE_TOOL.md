---
description: >-
  Ansible Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **ansible_tool** operations securely and efficiently.
...
{
  "name": "ansible_tool",
  "description": "Executes ansible_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `ansible_tool:execute`).
...
class AnsibleToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_ansible_tool(input_data: AnsibleToolInput) -> str:
    """
    Implements the core logic for Ansible Tool.
    """
