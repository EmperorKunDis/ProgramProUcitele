---
description: >-
  Sql Query Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **sql_query_tool** operations securely and efficiently.
...
{
  "name": "sql_query_tool",
  "description": "Executes sql_query_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `sql_query_tool:execute`).
...
def execute_sql_query_tool(input_data: SqlQueryToolInput) -> str:
    """
    Implements the core logic for Sql Query Tool.
    """
