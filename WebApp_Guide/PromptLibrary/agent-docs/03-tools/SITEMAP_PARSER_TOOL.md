---
description: >-
  Sitemap Parser Tool - Production-Ready Tool Specification.
...
# 🛠️ Sitemap Parser Tool

> **Capability**: Allows the agent to perform **sitemap_parser_tool** operations securely and efficiently.
...
```json
{
  "name": "sitemap_parser_tool",
  "description": "Executes sitemap_parser_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `sitemap_parser_tool:execute`).
...
class SitemapParserToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_sitemap_parser_tool(input_data: SitemapParserToolInput) -> str:
    """
    Implements the core logic for Sitemap Parser Tool.
    """
