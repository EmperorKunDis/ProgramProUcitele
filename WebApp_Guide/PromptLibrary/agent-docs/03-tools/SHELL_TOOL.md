---
description: >-
  Shell Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **shell_tool** operations securely and efficiently.
...
{
  "name": "shell_tool",
  "description": "Executes shell_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `shell_tool:execute`).
...
def execute_shell_tool(input_data: ShellToolInput) -> str:
    """
    Implements the core logic for Shell Tool.
    """
