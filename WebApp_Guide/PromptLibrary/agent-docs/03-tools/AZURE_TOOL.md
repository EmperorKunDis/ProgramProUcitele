---
description: >-
  Azure Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **azure_tool** operations securely and efficiently.
...
{
  "name": "azure_tool",
  "description": "Executes azure_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `azure_tool:execute`).
...
def execute_azure_tool(input_data: AzureToolInput) -> str:
    """
    Implements the core logic for Azure Tool.
    """
