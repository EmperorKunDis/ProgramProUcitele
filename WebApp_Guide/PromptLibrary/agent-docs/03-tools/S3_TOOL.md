---
description: >-
  S3 Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **s3_tool** operations securely and efficiently.
...
{
  "name": "s3_tool",
  "description": "Executes s3_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `s3_tool:execute`).
...
def execute_s3_tool(input_data: S3ToolInput) -> str:
    """
    Implements the core logic for S3 Tool.
    """
