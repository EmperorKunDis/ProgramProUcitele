---
description: >-
  Asana Tool - Production-Ready Tool Specification.
...
> **Capability**: Allows the agent to perform **asana_tool** operations securely and efficiently.
...
{
  "name": "asana_tool",
  "description": "Executes asana_tool operations with strict validation.",
  "parameters": {
    "type": "object",
    "properties": {
      "target_resource": {
...
- **Authentication**: Usage requires Validated Bearer Token (Scope: `asana_tool:execute`).
...
class AsanaToolInput(BaseModel):
    target: str = Field(..., description="Target Endpoint")
    params: Dict[str, Any] = Field(default_factory=dict)

def execute_asana_tool(input_data: AsanaToolInput) -> str:
    """
    Implements the core logic for Asana Tool.
    """
